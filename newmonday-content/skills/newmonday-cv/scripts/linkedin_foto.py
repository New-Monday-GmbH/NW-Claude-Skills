...
def main():
    ...
    # Der Fotokasten ist 79pt breit, also 79/72 Zoll. Entscheidend ist die
    # Aufloesung im Druck, nicht die Pixelzahl: 400x400 ergibt beschnitten
    # 298 px und damit rund 270 dpi — das ist gut, keine Warnung wert.
    dpi = round(Image.open(ergebnis).size[0] / (79 / 72))
    print(f"Aufloesung im Layout: ~{dpi} dpi")
    if dpi < 200:
        print("Hinweis: unter 200 dpi — im Druck sichtbar weich. "
              "Ein schaerferes Foto beim Kandidaten anfragen lohnt sich.")
