...
Erste Quelle ist simple-icons ueber die npm-Registry: 3400+ einfarbige
Markenlogos, ohne Schluessel, und npm ist auch dort erreichbar, wo sonst alles
gesperrt ist. Einfarbig passt zum Layout — die vorhandenen Logos sind es auch.
